...
ActiveRecord::Schema.define(version: 20200606165259) do
  ...
  create_table "lists_statements", force: :cascade do |t|
    t.bigint "list_id"
    t.bigint "statement_id"
    t.index ["list_id"], name: "index_lists_statements_on_list_id"
    t.index ["statement_id"], name: "index_lists_statements_on_statement_id"
  end
